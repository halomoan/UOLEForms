...
class Admin_Controller extends MY_Controller
{
	public function __construct()
	{
        ...
        {
            /* Load */
            $this->load->config('portal/dp_config');
            $this->load->library('portal/page_title');
            $this->load->library('portal/breadcrumbs');
            $this->load->model('portal/core_model');
            $this->load->helper('menu');
            $this->lang->load(array('portal/main_header', 'portal/main_sidebar', 'portal/footer', 'portal/actions'));

            /* Load library function  */
            //$this->breadcrumbs->unshift(0, $this->lang->line('menu_dashboard'), 'portal/dashboard');
