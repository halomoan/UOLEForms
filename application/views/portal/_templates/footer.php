...
?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><span id="confirm_title">Confirmation</span></h4>
                    </div>
                    <div class="modal-body">
                        <p><span id="confirm_text"></span></p>
                    </div>
        ...
        <div class="modal modal-info fade" id="modal-dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                        <h4 class="modal-title"><span id="dialog_title">Feedback</span></h4>
                    </div>
                    <div class="modal-body">
                        <p><span id="dialog_text"></span></p>
                    </div>
                    <div class="modal-footer">
        ...
        <script src="<?php echo base_url($plugins_dir . '/bootstrap-colorpicker/bootstrap-colorpicker.min.js'); ?>"></script>
