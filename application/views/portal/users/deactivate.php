                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <div class="box">
                                ...
                                <div class="box-body">
                                    <?php echo form_open('portal/users/deactivate/'. $id, array('class' => 'form-horizontal', 'id' => 'form-status_user')); ?>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <?php echo anchor('portal/users', lang('actions_cancel'), array('class' => 'btn btn-default btn-flat')); ?>
                                                </div>
                                            </div>
                                        </div>
                                    <?php echo form_close();?>
