                        ...
                        <div class="col-md-12">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><?php echo anchor('portal/prefs/interfaces/admin', lang('menu_int_admin')); ?></li>
                                    <li><?php echo anchor('portal/prefs/interfaces/public', lang('menu_int_public')); ?></li>
                                </ul>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <div class="btn-group">
                                                        ...
                                                        <?php echo anchor('portal/prefs/reset_interfaces_admin', lang('actions_default_values'), array('class' => 'btn btn-danger btn-flat')); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php echo form_close();?>
