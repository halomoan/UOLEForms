...
class Groups extends Admin_Controller {
	...
	public function create()
	{
        ...
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, lang('menu_groups_create'), 'portal/groups/create');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
		...
		if ($this->form_validation->run() == TRUE)
		{
			...
			if ($new_group_id)
			{
				...
				redirect('portal/groups', 'refresh');
			}
		}
		else
		{
	...
	public function edit($id)
	{
        ...
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, lang('menu_groups_edit'), 'portal/groups/edit');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
