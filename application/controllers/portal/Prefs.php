...
class Prefs extends Admin_Controller {
    ...
    public function __construct()
    {
        ...
        /* Load :: Common */
        $this->load->model('portal/preferences_model');
        $this->lang->load('portal/preferences');

        /* Breadcrumbs :: Common */
        $this->breadcrumbs->unshift(1, lang('menu_preferences'), 'portal/prefs');
    }
	...
	public function index()
	{
        ...
        else
        {
            ...
            /* Load Template */
            $this->template->admin_render('portal/prefs/index', $this->data);
        }
	}
	...
	public function interfaces($type = NULL)
	{
        ...
        /* Breadcrumbs :: Common */
        $this->breadcrumbs->unshift(2, lang('menu_interfaces'), 'portal/prefs/interfaces/admin');

        if ($type == 'admin')
        {
            /* Breadcrumbs */
            $this->breadcrumbs->unshift(3, lang('menu_int_admin'), 'portal/prefs/interfaces/admin');
            $this->data['breadcrumb'] = $this->breadcrumbs->show();
            ...
            if ($this->form_validation->run() == TRUE)
            {
                ...
                redirect('portal/prefs/interfaces/admin', 'refresh');
            }
            else
            {
                /* Load Template */
        ...
        {
            /* Breadcrumbs */
            $this->breadcrumbs->unshift(3, lang('menu_int_public'), 'portal/prefs/interfaces/public');
            $this->data['breadcrumb'] = $this->breadcrumbs->show();
            ...
            if ($this->form_validation->run() == TRUE)
            {
                ...
                redirect('portal/prefs/interfaces/public', 'refresh');
            }
            else
            {
                /* Load Template */
