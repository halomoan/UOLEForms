...
class Users extends Admin_Controller {
	...
	{
		/* Breadcrumbs */
		$this->breadcrumbs->unshift(2, lang('menu_users_create'), 'portal/users/create');
		$this->data['breadcrumb'] = $this->breadcrumbs->show();
		...
		else
		{
			...
			/* Load Template */
			$this->template->admin_render('portal/users/create', $this->data);
		}
	}
	...
	{
		/* Load Template */
		$this->template->admin_render('portal/users/delete', $this->data);
	}
	...
	public function edit($id)
	{
		...
		/* Breadcrumbs */
		$this->breadcrumbs->unshift(2, lang('menu_users_edit'), 'portal/users/edit');
		$this->data['breadcrumb'] = $this->breadcrumbs->show();
		...
		/* Load Template */
		$this->template->admin_render('portal/users/edit', $this->data);
	}
	...
	public function deactivate($id = NULL)
	{
		...
		/* Breadcrumbs */
		$this->breadcrumbs->unshift(2, lang('menu_users_deactivate'), 'portal/users/deactivate');
		$this->data['breadcrumb'] = $this->breadcrumbs->show();
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			/* Load Template */
			$this->template->admin_render('portal/users/deactivate', $this->data);
		}
		else
		{
	...
	{
		/* Breadcrumbs */
		$this->breadcrumbs->unshift(2, lang('menu_users_profile'), 'portal/groups/profile');
		$this->data['breadcrumb'] = $this->breadcrumbs->show();
		...
		/* Load Template */
		$this->template->admin_render('portal/users/profile', $this->data);
	}
